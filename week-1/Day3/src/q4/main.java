...
class Book {
 ...
 public Book(int id, String isbn, String title, String author, int price, int copies) {
  this.id = id;
  this.isbn = isbn;
  this.title = title;
  this.author = author;
...
public class BookRead {
 File fd = new File("book.txt");
 FileReader fr = new FileReader(fd);

 private LinkedList<Book> books = new LinkedList<>();try(
