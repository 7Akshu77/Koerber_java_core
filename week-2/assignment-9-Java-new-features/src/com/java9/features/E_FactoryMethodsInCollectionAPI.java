...
//        List<String> list2=Collections.unmodifiableList(list);
    ...
    // java 9 way of creating immutable collection
        List<String> l2 = List.of("foo","bar");
        // the code takes
...
//        Map<String, Integer> map2=Collections.unmodifiableMap(map);
        ...
        Map<String , Integer>map = Map.of("amit",98,"ekta",88,"raj",77);
...
//
        ...
        Map<String,Integer> mp2 = Map.ofEntries(e1,e2,e3);
...
Map<String,Integer> mp = Map.ofEntries(Map.entry("amit",92),Map.entry("ekta",88),Map.entry("kapil",70));
